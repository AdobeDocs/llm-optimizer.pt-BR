...
description: Saiba como a LLM Optimizer analisa a presença da sua empresa na Wikipédia e fornece recomendações para melhorar a visibilidade da marca nos resultados de Pesquisas com IA.
...
![Painel de análise da Wikipédia](/help/dashboards/opportunities/assets/wikipedia-analysis-overview.png)
...
|---|---|
| Resolver problemas de tom de comunicado à imprensa | Crítico |
| Adicione referências para atingir o padrão da indústria | Crítico |
...
| Adicione imagens para alcançar o padrão da indústria | Média |
| Adicionar categorias para melhorar a descoberta | Baixa |
...
![Guia Comparação de Mercado](/help/dashboards/opportunities/assets/wikipedia-analysis-market-comparison.png)
...
As edições na Wikipédia devem ser feitas diretamente na Wikipédia, seguindo as [diretrizes editoriais](https://en.wikipedia.org/wiki/Wikipedia:Editing_policy). O LLM Optimizer fornece as recomendações específicas e as fontes de dados de que você precisa — as edições são feitas na Wikipédia. Se o seu artigo foi sinalizado para problemas de tom, revise a [política de ponto de vista neutro](https://en.wikipedia.org/wiki/Wikipedia:Neutral_point_of_view) da Wikipédia antes de fazer alterações.
...
A oportunidade Análise da Wikipedia requer um artigo da Wikipedia existente. Se sua marca não tem uma, criar uma página da Wikipédia que atenda às [diretrizes de capacidade da Wikipédia](https://en.wikipedia.org/wiki/Wikipedia:Notability) é uma etapa GEO fundamental que vale a pena priorizar antes de outras otimizações.
