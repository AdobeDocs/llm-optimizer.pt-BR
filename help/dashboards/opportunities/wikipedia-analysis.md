---
title: Análise da Wikipédia
description: Saiba como o LLM Optimizer analisa a presença da sua empresa na Wikipédia e fornece recomendações para melhorar a visibilidade da marca nos resultados de pesquisa com IA.
...
![Painel Análise da Wikipedia](/help/dashboards/opportunities/assets/wikipedia-analysis-overview.png)
...
![Guia Sugestões e Orientação](/help/dashboards/opportunities/assets/wikipedia-analysis-suggestions.png)
...
|---|---|
| Resolver problemas de tom de comunicado de imprensa | Crítico |
| Adicionar referências para atingir o padrão do setor | Crítico |
| Seção Adicionar produtos e serviços | Crítico |
| Adicionar caixa de informações | Alta |
| Aprimorar caixa de informações com campos ausentes | Alta |
| Adicionar seção de histórico da empresa | Alta |
| Adicionar seções de conteúdo | Alta |
| Adicionar seção de liderança e gerenciamento | Média |
| Adicionar imagens para alcançar o padrão do setor | Média |
| Adicionar categorias para melhorar a capacidade de descoberta | Baixa |
| Status de qualidade do artigo | Informativo |
...
![Guia Comparação do mercado](/help/dashboards/opportunities/assets/wikipedia-analysis-market-comparison.png)
...
![Guia Seu artigo](/help/dashboards/opportunities/assets/wikipedia-analysis-your-article.png)
...
[Ver análise da Wikipédia na demonstração do Frescopa](https://play.llmo.now/org/demo-org/opportunities/wikipedia-analysis/f4d0aa61-61e0-416f-a265-0cfddf17c3aa?siteId=frescopa-demo)
...
As edições na Wikipédia devem ser feitas diretamente na Wikipédia, seguindo as [diretrizes editoriais](https://pt.wikipedia.org/wiki/Wikip%C3%A9dia:Pol%C3%ADtica_de_edi%C3%A7%C3%A3o). O LLM Optimizer fornece as recomendações específicas e as fontes de dados de que você precisa — as edições são feitas na Wikipédia. Se o seu artigo foi sinalizado para problemas de tom, revise a [política de ponto de vista neutro](https://pt.wikipedia.org/wiki/Wikip%C3%A9dia:Princ%C3%ADpio_da_imparcialidade) da Wikipédia antes de fazer alterações.
...
A oportunidade Análise da Wikipedia requer um artigo da Wikipedia existente. Se a sua marca não tem uma, criar uma página da Wikipédia que atenda às [diretrizes de relevância da Wikipédia](https://pt.wikipedia.org/wiki/Wikip%C3%A9dia:Crit%C3%A9rios_de_notoriedade) é uma etapa fundamental de GEO que vale a pena priorizar antes de outras otimizações.
