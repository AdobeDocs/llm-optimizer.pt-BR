...
description: Saiba como usar o painel de Presenças da marca para entender como sua marca é percebida no nível de respostas geradas por IA.
...
* [Comparação com outros](##others-comparison)
...
* **Plataforma** - Escolha qual mecanismo de IA analisar. Atualmente, o LLM Optimizer é compatível com ChatGPT, Visões gerais da IA do Google, Modo de IA do Google, Copiloto do Microsoft, Google Gemini e Perplexity.
* **Origem dos Prompts** - Escolha a origem dos prompts. A origem pode ser inserida pelo usuário ou gerada pela IA.
* **Prompt branding** - Filtre os resultados com os prompts com marca ou sem marca.
...
Na seção de análises de tendências de sentimento, você pode acompanhar como sua marca é percebida nas respostas da IA de amostra. A métrica de tendência de sentimento pode ser positiva, neutra ou negativa. Por exemplo, pode ser positivo se as respostas destacarem a qualidade do produto ou negativo se mencionarem um serviço ruim. O gráfico de tendências mostra as mudanças na percepção da marca semana a semana. Esta seção é preenchida somente depois que sua marca é mencionada.

![Tendência de sentimento](/help/dashboards/assets/sentiment-trend.png)

## Insights de dados e &lt;strong>participação de voz&lt;/strong> {#data-insights}

Ao arredondar para cima o painel, temos duas tabelas importantes: insights de dados e &lt;strong>participação de voz&lt;/strong>. As informações apresentadas nessas tabelas ajudarão você a identificar onde sua marca é forte e onde a otimização é necessária.

Usando a tabela **insights de dados**, você pode explorar tópicos e perguntas ao usuário para avaliar e otimizar o impacto do conteúdo. Os resultados são detalhados por tópicos e prompts. Enquanto isso, a tabela **&lt;strong>participação de voz&lt;/strong>** compara a voz da sua marca a outras marcas em vários tópicos e ajuda a identificar lacunas e priorizar tópicos futuros.
...
* **Pontuação de visibilidade** - A pontuação de visibilidade para esse tópico. Ele reflete fatores ponderados como menções, citações, sentimento e classificação.
...
* **Sentimento** - A percepção da marca nas respostas da IA, pois se relaciona a cada tópico calculado como uma média em todas as semanas. Preenchido somente quando sua marca é realmente mencionada.
...
>[!TAB &lt;strong>participação de voz&lt;/strong>]

A tabela &lt;strong>participação de voz&lt;/strong> fornece uma visão comparativa de como sua marca atua em todos os tópicos principais nas respostas geradoras de IA. Ele ajuda a identificar lacunas de visibilidade, rastrear o desempenho competitivo e priorizar áreas para otimização. Ela exibe as seguintes métricas:
...
* **Classificação** - A classificação do &lt;strong>participação de voz&lt;/strong> da sua marca, relativa a todas as outras marcas identificadas.
* **&lt;strong>participação de voz&lt;/strong>** - A porcentagem do total de menções que sua marca retém em respostas geradas por IA.
* **Cinco principais** - As cinco principais marcas mencionadas com mais frequência para os mesmos tópicos. As marcas são organizadas por seu &lt;strong>participação de voz&lt;/strong> (do mais alto para o mais baixo).
...
* Priorize tópicos de alta popularidade com baixa visibilidade - otimização de foco onde a demanda de público-alvo é forte, mas sua presença da marca é fraca.
* Rastrear alterações no sentimento - detecte tópicos onde as menções estão em tendência negativa ou neutra e coordene sua resposta.
