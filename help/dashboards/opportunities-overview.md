...
| [Tráfego bloqueado por robots.txt](/help/dashboards/opportunities/traffic-blocked-by-robots.md) | GEO técnico | Analisa o seu arquivo robots.txt em busca de regras que bloqueiam seletivamente agentes de IA de conteúdo que, de outra forma, seria publicamente acessível. Relata URLs afetados e agentes bloqueados. | Atualize o arquivo robots.txt para permitir o acesso de rastreadores de IA compatíveis, quando apropriado. |
| [Erros de tráfego agêntico](/help/dashboards/opportunities/agentic-traffic-errors.md) | GEO técnico | Monitora os logs da CDN em busca de respostas de erro 404, 403 e 5xx retornadas aos agentes de IA. Relata URLs afetados e o total de acessos perdidos. | Corrigir links corrompidos, atualizar permissões e resolver problemas do lado do servidor para que o conteúdo principal retorne 200 respostas. |
...
| [Análise da Wikipédia](/help/dashboards/opportunities/wikipedia-analysis.md) | Fora do local | Analisa a página da sua empresa na Wikipédia em comparação com os concorrentes do setor, considerando referências, seções, extensão do conteúdo, imagens e integridade da caixa de informações. Identifica lacunas específicas onde sua página fica abaixo dos padrões do setor. | Analise as recomendações estratégicas geradas por IA para melhorar sua presença na Wikipédia, incluindo a adição de referências, o enriquecimento da caixa de informações, a expansão de seções e a melhoria da qualidade dos artigos. |
| [Análise de sentimentos do YouTube (Beta)](/help/dashboards/opportunities/youtube-sentiment-analysis.md) | Canais externos, redes sociais e comunidade | Analisa vídeos do YouTube citados no conjunto de prompts de Presença da marca, considerando menções à marca, sentimento, participação de mercado e tópicos recorrentes. Aparece somente quando vídeos do YouTube são detectados como citações do conjunto de prompts. | A revisão priorizou recomendações para melhorar a percepção da marca em todo o conteúdo do YouTube, incluindo ações sugeridas e as equipes responsáveis por implementá-las. |
| [Análise de sentimentos do Reddit (Beta)](/help/dashboards/opportunities/reddit-sentiment-analysis.md) | Canais externos, redes sociais e comunidade | Analisa os tópicos do Reddit citados no conjunto de prompts de Presença da marca, considerando menções à marca, sentimento, participação de voz e tópicos recorrentes. Aparece somente quando tópicos do Reddit são detectados como citações para o seu conjunto de prompts. | A revisão priorizou recomendações para melhorar a percepção da marca em todo o conteúdo do Reddit, incluindo ações sugeridas e as equipes responsáveis por implementá-las. |
| [Análise de sentimentos citados (Beta)](/help/dashboards/opportunities/cited-sentiment-analysis.md) | Canais externos, redes sociais e comunidade | Analisa os URLs mais citados detectados para o conjunto de prompts de Presença da marca, incluindo menções à marca, sentimento, participação de voz e tópicos recorrentes. | Analise as recomendações priorizadas para melhorar a percepção da marca nas páginas que os sistemas de IA mais citam ao responder a prompts sobre a sua marca. |
